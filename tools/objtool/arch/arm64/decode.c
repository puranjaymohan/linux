...
/*
 * Only used by the --noinstr option to objtool which isn't implemented for arm.
 * Dummy function to enable objtool to run.
 */
const char *arch_ret_insn(int len)
{
	static const char ret[] = { 0x00, 0x00, 0x00, 0x00 };
